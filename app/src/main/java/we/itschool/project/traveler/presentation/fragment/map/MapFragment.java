...
public class MapFragment extends Fragment implements UserLocationObjectListener, CameraListener {
    ...
    public void initView(View view) {
        ...
        ll = view.findViewById(R.id.cl_map_main);
        mf = this;
        mapView = (MapView) view.findViewById(R.id.mv_map_map);
        ...
        name_layout = (TableLayout) view.findViewById(R.id.nameofsheet);
        content_layout = (TableLayout) view.findViewById(R.id.content);

        LinearLayout llBottomSheet = (LinearLayout) view.findViewById(R.id.bottomSheet);
...
//        SetSettingsButton();
    ...
    public static void SetPlacesInMap(Point position){
        ...
        call.enqueue(new Callback<ResponseOTM>() {
            ...
            public void onFailure(@NonNull Call<ResponseOTM> call, @NonNull Throwable t) {
                ...
                Toast.makeText(mf.getContext(), "[WARNING] " +t.toString(),
        ...
        call.enqueue(new Callback<ResponseOTMInfo>() {
            ...
            public void onResponse(@NonNull Call<ResponseOTMInfo> call, @NonNull Response<ResponseOTMInfo> response) {
                ...
                if (response.body() != null) {
                    ...
                    newFragment.show(mf.getActivity().getSupportFragmentManager().beginTransaction(), "info");
                }
            }
            @Override
            public void onFailure(@NonNull Call<ResponseOTMInfo> call, @NonNull Throwable t) {
                Log.e("!SomethingWentWrong(I)!", t.toString());
                Toast.makeText(mf.context, "[WARNING] " +t.toString(),
                        Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void SetSettingsButton(){
        ImageButton settings = new ImageButton(context);
        ...
        settings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                newFragment.show(mf.getActivity().getSupportFragmentManager().beginTransaction(), "settings");
            }
        });
    ...
    private void SetFindUserButton(){
        ImageButton findUser = new ImageButton(context);
        ...
        shapeDrawableFindUser.setFillColor(ContextCompat.getColorStateList(context, R.color.white));
        shapeDrawableFindUser.setStroke(1.5f, ContextCompat.getColor(context, R.color.black));
        ...
        row_of_btn = new TableRow(context);
    ...
    private void SetListOfFavButton(){
        ImageButton favorites = new ImageButton(context);
        ...
        shapeDrawableFavorites.setFillColor(ContextCompat.getColorStateList(context, R.color.white));
        shapeDrawableFavorites.setStroke(2f, ContextCompat.getColor(context, R.color.black));
            ...
            public void onClick(View view) {
                ...
                if (ArrOfFavorite != null) {
                    for (String i : ArrOfFavorite.keySet()) {
                        ...
                        TableLayout tableRowInfo = new TableLayout(context);
                        tableRowInfo.setGravity(Gravity.LEFT);

                        ImageView myImgView = new ImageView(context);
    ...
    public boolean checkLocationAccess (){
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED ||
            ...
            ActivityCompat.requestPermissions(mf.getActivity(), new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION }, 1);
            return false;
        }
    ...
    public boolean checkLocation(){
        LocationManager locationManager = (LocationManager) mf.getActivity().getSystemService(Context.LOCATION_SERVICE);
    ...
    public boolean hasConnection() {
        ConnectivityManager cm = (ConnectivityManager) mf.getActivity().getSystemService(Context.CONNECTIVITY_SERVICE);
