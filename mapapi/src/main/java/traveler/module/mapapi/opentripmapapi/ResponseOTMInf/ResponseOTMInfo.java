...
public class ResponseOTMInfo implements Parcelable {
    ...
    @Expose
    private Point point;
    public final static Creator<ResponseOTMInfo> CREATOR = new Creator<ResponseOTMInfo>() {


        @SuppressWarnings({
            "unchecked"
        })
        public ResponseOTMInfo createFromParcel(Parcel in) {
            return new ResponseOTMInfo(in);
        }

        public ResponseOTMInfo[] newArray(int size) {
            return (new ResponseOTMInfo[size]);
        }

    }
    ;

    protected ResponseOTMInfo(android.os.Parcel in) {
